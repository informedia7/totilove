...
-- Backfill admin_notifications schema for existing installations
...
COMMENT ON TABLE admin_notifications IS 'Admin inbox notifications including support messages';
