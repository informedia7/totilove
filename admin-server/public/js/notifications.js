...
function showConfirm(message, title = 'Confirm Action', confirmText = 'Confirm', cancelText = 'Cancel', type = 'warning') {
    return new Promise((resolve) => {
        ...
        const typeColors = {
            danger: { bg: '#dc3545', hover: '#c82333', fg: '#ffffff' },
            warning: { bg: '#ffc107', hover: '#e0a800', fg: '#333333' },
            info: { bg: '#17a2b8', hover: '#138496', fg: '#ffffff' },
            success: { bg: '#16a34a', hover: '#15803d', fg: '#ffffff' },
            account_suspend: { bg: '#d1fae5', hover: '#a7f3d0', fg: '#065f46' },
            account_delete: { bg: '#fecaca', hover: '#fca5a5', fg: '#991b1b' },
            account_delete_blacklist: { bg: '#dc2626', hover: '#b91c1c', fg: '#ffffff' }
        };
        const colors = typeColors[type] || typeColors.warning;
        const fg = colors.fg != null ? colors.fg : '#ffffff';
