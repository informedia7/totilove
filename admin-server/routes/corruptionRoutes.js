...
// Orphan profile image scan/delete routes (scan first, then selective delete)
router.get('/orphan-files', corruptionController.scanOrphanedImageFiles.bind(corruptionController));
router.post('/orphan-files/delete', corruptionController.deleteOrphanedImageFiles.bind(corruptionController));
