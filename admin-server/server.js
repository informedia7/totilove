...
// Rate limiting - disabled if RATE_LIMIT_ENABLED=false in .env
...
if (rateLimitingEnabled) {
    ...
    app.use('/api/chat-images', adminLimiter);
    app.use('/api/backup', adminLimiter);
    app.use('/api/presence-tests', adminLimiter);
...
const possibleUploadPaths = [
    ...
    '/app/app/uploads', // explicit Railway volume mount
