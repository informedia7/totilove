...
let searchResultTotal = null; // Total count of search results
...
const TalkState = {
    ...
    getSearchResultTotal: () => searchResultTotal,
    setSearchResultTotal: (total) => { searchResultTotal = total; },
...
// Make TalkState globally available
window.TalkState = TalkState;
