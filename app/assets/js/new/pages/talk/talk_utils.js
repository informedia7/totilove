...
const Utils = {
    ...
    image: {
        ...
        createContainer: function (attachment, isSingle = false, index = 0, messageType = null, galleryItems = null) {
            ...
            img.onclick = () => {
                ...
                if (isPortraitMobileTouch) {
                    // Portrait mobile image taps are handled by talk_message-actions.js
                    return;
                }

                if (typeof openImageViewer === 'function') {
                    const imagePath = attachment.file_path || attachment.thumbnail_path;
                    openImageViewer(imagePath, '', galleryItems, index);
                }
            };
