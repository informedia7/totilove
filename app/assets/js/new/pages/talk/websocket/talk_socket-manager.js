...
function initializeWebSocket() {
    ...
    try {
        ...
        socket.on('authenticated', (data) => {
            ...
            // Do not emit join_user_room here.
            // Server authenticate handler already joins user room and emits "authenticated".
            // Emitting join_user_room in response to "authenticated" causes an auth loop.
