...
class DropdownManager {
     ...
     */
    populateSimpleDropdown({ selectId, dataKey, data, currentValueId, section, valueMapper }) {
        ...
        data[dataKey].forEach(item => {
            ...
            const matchValue = valueMapper ? valueMapper(item) : itemName;
            ...
            // Set selected if matches current value (handle 'Not specified' case)
            if (currentValue && matchValue && matchValue.toLowerCase() === currentValue.toLowerCase()) {
