...
class CompatibilityEngine {
    ...
    calculatePreferenceMatchingScore(userA, userB) {
        ...
        const preferencesToCheck = [
            ...
            { pref: 'preferred_smoking', attr: 'smoking_id', compare: matchesId },
            { pref: 'preferred_drinking', attr: 'drinking_id', compare: matchesId },
    ...
    calculateCompatibility(userA, userB) {
        ...
        const hasData = (
            ...
            userA.relationship_type || userB.relationship_type ||
                userA.smoking_id || userB.smoking_id ||
            userA.drinking_id || userB.drinking_id ||
        ...
        const perfectMatches = {
            ...
            smoking: userA.smoking_id && userB.smoking_id && userA.smoking_id === userB.smoking_id,
            drinking: userA.drinking_id && userB.drinking_id && userA.drinking_id === userB.drinking_id,
