        ...
        try {
            ...
            const userResult = await db.query(`
                SELECT u.id, u.real_name, u.email, u.birthdate, u.gender,
                      ...
                      ua.body_type_id, ua.eye_color_id, ua.hair_color_id,
            ...
            try {
                const interestsResult = await db.query(
                    `
                        SELECT 
                            uic.id as interest_id,
                            uic.name as interest_name
                        FROM users u
                ...
                console.warn('[DEBUG] Could not load user interests:', interestsError.message);
            }

            const firstInterest = userInterests[0] || null;
            const interestNames = userInterests.map(i => i.interest_name).join(', ');
            ...
            const userData = {
                ...
                occupation: user.occupation_category_id != null ? String(user.occupation_category_id) : '', // For backward compatibility
                    ...
                    smoking: user.smoking_id != null ? String(user.smoking_id) : '', // For backward compatibility
                drinkingId: user.drinking_id != null ? String(user.drinking_id) : '',
                drinking: user.drinking_id != null ? String(user.drinking_id) : '', // For backward compatibility
                ...
                // Interest
                interest_category: interestNames || '',
                current_interest_category_name: interestNames || ''
            };
                ...
                <body>
                    <div class="container">
                        ...
                        ${renderSection('Lifestyle (IDs)', {
                            ...
                            'Smoking ID': user.smoking_id,
                            'Drinking ID': user.drinking_id,
                        ...
                        ${renderSection('Interest Category', {
                            'Interest ID': firstInterest?.interest_id || null,
                            'Interest Name': interestNames || null
                        })}
