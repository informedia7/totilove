...
class MessageRoutes {
    ...
    setupRoutes() {
        ...
        // Message reactions
        router.post('/:messageId/reaction', (req, res) => this.messageController.setMessageReaction(req, res));
        router.delete('/:messageId/reaction', (req, res) => this.messageController.removeMessageReaction(req, res));
