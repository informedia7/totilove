...
function createLanguageRoutes(db, authMiddleware) {
     ...
     */
    router.get('/api/profile/languages', lookupLimiter, async (req, res) => {
     ...
     */
    router.post('/api/profile/languages', apiLimiter, async (req, res) => {
            ...
            if (languages.length > 0) {
                for (const lang of languages) {
                    ...
                    if (!language_id) {
                        ...
                        return res.status(400).json({
                            success: false,
                            error: 'language_id is required for each language'
                        });
                    }
