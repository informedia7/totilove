...
function configureExpress(app) {
    ...
    app.use((req, res, next) => {
        ...
        const cspPolicy = [
            "default-src 'self'",
            "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://static.cloudflareinsights.com", // allow Cloudflare Web Analytics beacon script
            "script-src-elem 'self' 'unsafe-inline' https://static.cloudflareinsights.com", // explicit script element policy
            ...
            "font-src 'self' data:",
            "connect-src 'self' https://static.cloudflareinsights.com https://cloudflareinsights.com", // allow analytics beacon transport
