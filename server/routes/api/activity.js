...
function setupActivityRoutes(app, activityController) {
    ...
    app.delete('/api/activity/viewers/:viewerId', (req, res) => {
        activityController.removeViewer(req, res);
    });
    ...
    app.delete('/api/activity/who-liked-me/:userId', (req, res) => {
        activityController.hideIncomingLike(req, res);
    });
